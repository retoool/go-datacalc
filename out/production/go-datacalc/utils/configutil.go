...
var (
	HisCalcBeginTime = GetConfig("task.hiscalc.begintime")
	HisCalcEndTime   = GetConfig("task.hiscalc.endtime")
	HisCurveCalcTime = GetConfig("task.hiscalc.calctime")
	DelDataBeginTime = GetConfig("task.deldata.begintime")
	DelDataEndTime   = GetConfig("task.deldata.endtime")
)
